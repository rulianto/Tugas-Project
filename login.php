...
<body>
  ...
  <div class="container-xxl" data-aos="zoom-in-up" data-aos-delay="200" data-aos-duration="1000">
          ...
          <div class="card-body">
            ...
            <div class="app-brand justify-content-center">
              <a href="index.html" class="app-brand-link gap-2">
                <span class="app-brand-text demo text-body fw-bolder">CinemaLabTi21</span>
              </a>
            </div>
            <!-- /Logo -->
            <form method="POST">
